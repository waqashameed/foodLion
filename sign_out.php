    ...
    <div class="container">
        <div class="row" style="opacity: 0.9;">
            ...
            <div class="col-lg-6 col-md-8 login-box">
                ...
                <img class="car-img-top" src="assets/images/user-icon.png" alt="" style="padding:20px;margin-left:5px;height:150px;width:150px;">
                        ...
                        <form method="post">    
                            <div class="col-lg-12 loginbttm">
                                ...
                                <div class="col-lg-6 login-btm login-button">
                                    ...
                                    <button type="submit" class="btn btn-outline-primary" style="text-align: center;" name="logout"> Logout</button>
